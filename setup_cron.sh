...
CRON_DAYEND="30 17,18,20,22 * * 1-5 cd $DIR && $PYTHON collector.py --dayend >> $DIR/data/cron.log 2>&1"
...
echo "  DAYEND:  5:30 PM, 6:30 PM, 8:30 PM, 10:30 PM Mon-Fri (FII/DII + participant OI)"
echo ""
